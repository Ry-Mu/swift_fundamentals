...
//Here the Person class has  one stored property and it has a default value of "H. Sapiens". Since we declared the property as a variable it is both readable and writable (meaning we can access it and change it).

var myNewPerson = Person()                 // Note use of type inference to infer that it is "Person" type
myNewPerson.species = "Homo Sapiens"       // We can change the property
print("\(myNewPerson.species)")            // And we can access it!
...
var myonePerson = onePerson()
//myonePerson.species = "Homo Sapiens"       // ! => Cannot assign to 'species' in myPerson
...
var myMethodPerson: methodPerson = methodPerson()
myMethodPerson.speak()                             // Note we call method similar to how we access properties
...
var myLastPerson: lastPerson = lastPerson(name: "Jay")   // Now we have to pass a param to Person initialization.
myLastPerson.speak()                             // Note we call method similar to how we access properties.
