...
class Person {
    var species = "H. Sapiens" //Note this function doesn't get called explicityly. It is 
                            //called when creating an instance using the initialiation syntax -- "Person()"
    var name: String
    init(name: String) {  //Note this function doesn't get called explicityly. It is
                          //called when creating an instance using the initialiation
                          //syntax -- "Person()"
...
class Developer1: Person {         // Here we specify that Person is the "Superclass"
...
//var favoriteLanguage1: String       // Declaring the favoriteLanguage property in Developer means that
// it is only available in Developer and Developer's subclasses.

//init(name: String, favoriteLanguage1: String) {           // Developer's init method takes in
    // a name and a favoriteLanguage.
    //self.favoriteLanguage1 = favoriteLanguage1               // We set the favoriteLanguage property.
...
//which allows us to call upon the superclass' initialization method. Note that super.init should be called after the initialization of the child class properties.
